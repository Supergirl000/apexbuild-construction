...
export function Footer() {
  ...
  return (
    <footer className="bg-[#111111] text-white">
      <div className="container-px mx-auto grid max-w-7xl gap-8 py-10 lg:grid-cols-[1.2fr_0.8fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-slate-300">{siteConfig.description}</p>
          <div className="mt-4 inline-flex items-center gap-2 border border-white/10 bg-white/5 px-4 py-3 text-xs font-black uppercase tracking-wide text-slate-200">
            <ShieldCheck className="h-4 w-4 text-[var(--color-accent)]" />
            Licensed. Insured. Site supervised.
          </div>
        </div>
        ...
        <div>
          ...
          <Link href="/contact" className="mt-5 inline-flex items-center gap-2 bg-[var(--color-primary)] px-5 py-3 text-sm font-black uppercase tracking-wide text-white transition hover:bg-[var(--color-primary-dark)]">
